...
func main() {
	...
	dsn := "host=ec2-54-198-252-9.compute-1.amazonaws.com user=hlqzztfuidtiwo password=100299 dbname=dfrramkg6fcfcp port=5432 sslmode=disable TimeZone=Asia/Shanghai"
	db, err := gorm.Open(postgres.Open(dsn), &gorm.Config{})
